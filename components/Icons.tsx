...
export const Logo = ({ className }: { className?: string }) => (
  ...
  >
    <g className="fill-current text-white">
      {/* Top arc */}
      <path d="M 5 25 C 5 10, 95 10, 95 25 L 95 15 C 95 0, 5 0, 5 15 Z" />
      {/* Bottom arc */}
      <path d="M 5 75 C 5 90, 95 90, 95 75 L 95 85 C 95 100, 5 100, 5 85 Z" />
      {/* Left vertical bar */}
...
export const BookOpenIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v11.494m-5.22-8.485L3.75 9.75m11.25-1.226l2.97 1.485M12 6.253L5.22 3.75m6.78 2.503L18.75 3.75M12 6.253v11.494" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253L5.22 3.75m6.78 2.503L18.75 3.75M12 6.253v11.494M3.75 9.75h16.5M3.75 9.75L12 12.25m6.75-2.5L12 12.25m-8.25 5.25L12 14.75m6.75 2.75L12 14.75M3.75 17.25h16.5" />
    </svg>
);
...
export const CloudUploadIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
    </svg>
);

export const DragHandleIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
